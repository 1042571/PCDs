...
if (isset($_GET['delete'])) {
    ...
    $fetch_post_img = $delete_post->fetch_assoc();
...
<body>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="viewPost.php?delete=<?= $fetch_details['id']; ?>" onclick="return confirm('Are you sure!')">Delete</a>
                    </td>
                </tr>
            <?php
            }
    ...
    if ($total_pages > 1) {
        ...
        for ($i = 1; $i <= $total_pages; $i++) {
            echo "<a href='viewPost.php?page=$i'>$i</a> ";
        }
        echo "</div>";
    }
    ?>
