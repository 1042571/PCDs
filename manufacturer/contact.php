...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = $conn->prepare("INSERT INTO `manufacturercontact` (name, email, message, author_id) VALUES (?, ?, ?, ?)");
    $insert_query->bind_param("sssi", $name, $email, $msg, $manufacturerId);
