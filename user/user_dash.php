...
$sql = "SELECT * FROM posts WHERE role='admin' LIMIT $offset, $results_per_page";
$query = mysqli_query($conn, $sql);
$posts = mysqli_fetch_all($query, MYSQLI_ASSOC);

// Count total number of posts
$total_posts_sql = "SELECT COUNT(*) AS total FROM posts WHERE role='admin'";
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            ?>
                    <img src="../resource/blogUploads/<?= $post['image']; ?>" alt="Card Image">
            ...
            <?php
                ...
                echo '<div  class="error">No admin posts yet.</div>';
            }
            ?>
        </div>
        <!-- Pagination links -->
