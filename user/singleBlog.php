...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($authorid)) {
        ...
        $sql = "INSERT INTO comments (author_name, comment, post_id, author_id) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssii", $name, $comment, $postid, $authorid);
        if ($stmt->execute()) {
...
<?php
            ...
            echo '<div  class="error">No comments posted. Be the first!!</div>';
        }
?>
</div>
...
<div class="comment-form">
    ...
    <form action="#" method="post" id="commentForm">
        <input type="hidden" name="authorid" id="authorid" value="<?php echo $userid; ?>" />
