...
if (isset($_GET['delete'])) {
    ...
    $delete_post->bind_param("i", $delete_id);
    $delete_post->execute();
...
<body>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><?= $fetch_details['author_id']; ?></td>
                    <td><?= $fetch_details['created_at']; ?></td>
                    <td><?= $fetch_details['image']; ?></td>
                    <td><a href="viewPost.php?delete=<?= $fetch_details['id']; ?>" onclick="return confirm('Delete this account? The user related information will also be delete!')">Delete</a></td>
                </tr>
            <?php
            }
            ?>
    ...
    if ($total_pages > 1) {
        ...
        for ($i = 1; $i <= $total_pages; $i++) {
            echo "<a href='viewMyPost.php?page=$i'>$i</a> ";
        }
        echo "</div>";
    }
    ?>
